...
<div class="section_content">
	<p><span>1. </span>Most of the shapes have quite complex surface. Therefore small and rounded image tags (<span>Image Scale</span> about 0.4-0.6) are preferable 
	because they fit better to the shape. Thus they don't hide it but bold its beauty, especially on big canvas (960x960 +).</span></p>
	<p><span>2. </span>For multiple shape selection set <span>Shape/Magic Time</span> to 10-15 sec.</span></p>
	<p><span>3. </span>It's good to take in view following recommendations for your <span>Shape</span> choice:<br>
	- <span>A*</span>: Read the footnote.<br>
	- <span>Antenna</span> is a compound shape and is suitable for image tags. Not suitable for <span>Recent posts</span>, <span>Archives</span> due to the length of their tag text.
	By the same reason not suitable for <span>Authors</span>, unless they are presented with their avatars only.<br>
	- <span>Apple - 1</span>: Suitable for bigger cloud size and small number of tags (20 or 30), preferably icons. Even though the tags at the vertices may overlap.<br>
	- <span>Apple - 2</span>: Good for bigger cloud size and number of tags, but due to the shape's specificity the tags at the vertices may overlap.<br>
	- <span>Axes</span>: Suitable for relatively small (18 - 36) number of image tags - <span>Links</span>, <span>Pages</span>, <span>Authors</span> and <span>Menu</span>. 
	...
	- <span>Balloon</span>: Good for any type of cloud content and tags.<br>
	- <span>Beam</span>: Suitable for very small (5 - 10) number of image tags - <span>Menu</span>. First tag in the beam is anchored (it could be the 
	Home page). Set <span>Depth</span> to 1 for better result.	<span>Pages</span> and <span>Authors</span> are suitable too if their number is up to 10.<br>
	- <span>Black Hole**</span>: Read the footnote.<br>
	- <span>Blossom</span>: Better for bigger number image tags: 80 - 160. The stem of blossom grows with increase of tags.<br>
	- <span>Bowtie**</span>: Read the footnote.<br>
	- <span>Bulb</span>: Good for any type and number of tags.<br>
	- <span>Butterfly**</span>: Read the footnote.<br>
	...
	- <span>Circles</span>: One more flat shape where the tag in the center is still. This feature can be used for important tags - special pages, authors or links.
	...
	- <span>Dancers</span>: Good for bigger cloud size, for any type of content and tags.<br>
	- <span>Diaminity**</span>: Read the footnote.<br>
	- <span>Diamond</span>: Good for bigger canvas (960x960 and over). 40-50 tags give best results. Even though those at vertices overlap each other.<br>
	- <span>DNA that starts off horizontal</span> & <span>DNA that starts off vertical</span>: Most suitable for about 30 - 40 image tags or 60 - 80 text tags.<br>
	- <span>Domes</span>: Nice shape, good for bigger number of any type of tags.<br>
	- <span>Earing**</span>: Read the footnote.<br>
	- <span>Egg</span>: Good for any type and number of tags.<br>
	- <span>Egg Box**</span>: Read the footnote.<br>
	- <span>Excavator</span>: Good for bigger canvas (960x960 and over). 100-120 tags give best results. Even though those at vertices overlap each other.<br>
	- <span>Fir</span>: Better for image tags. Nicer for rotation around Y-axis. In that case the top tag stays still and could be used for an important link.<br>
	- <span>Fish - 1</span>: Good for image and short text tags. Best results with 50-80 tags. Some tags at fish tail overlap each other.<br>
	- <span>Fish - 2</span>: Good for image and short text tags. Best results with 100-150 tags. Overlapping of tags at the fish tail is reduced.<br>
	...
	- <span>Infinity - 1**</span>: Read the footnote.<br>
	- <span>Infinity - 2**</span>: Read the footnote.<br>
	- <span>Insect**</span>: Read the footnote.<br>
	- <span>Knot</span>: Good for any type and number of tags.<br>
	- <span>Lemon</span>: Good for any type and number of tags.<br>
	- <span>Lissajous**</span>: Read the footnote.<br>
	- <span>Love</span>: Nice shape, suitable for bigger cloud size and number of tags around 40-60, preferably icons.<br>
	- <span>M*</span>: Read the footnote.<br>
	- <span>Mobius**</span>: Read the footnote.<br>
	- <span>Monster**</span>: Read the footnote.<br>
	- <span>N*</span>: Read the footnote.<br>
	- <span>O*</span>: Read the footnote.<br>
	- <span>Owlish**</span>: Read the footnote.<br>
	- <span>Pearish**</span>: Read the footnote.<br>
	...
	- <span>Pillow</span>: Suitable for bigger canvas (960x960 and over) and big number of tags (120+). Even though tags at vertices may overlap each other.<br>
	- <span>Rim</span>: Good for any type and number of tags.<br>	
	- <span>Rings Knotwork</span>: Beautiful shape, good for bigger number of tags of any type.<br>
	- <span>Roundabout**</span>: Read the footnote.<br>
	...
	- <span>Spiral</span>: A flat shape where the tag in the center is still. This feature can be used for important tags - special pages, authors or links.<br>
	- <span>Spring</span>: Suitable when number of tags is around 30 - 60.<br>
	...
	- <span>Star - 1**</span>: Read the footnote.<br>
	- <span>Star - 2**</span>: Read the footnote.<br>
	- <span>Stool</span>: Good for any type and number of tags.<br>
	- <span>Star Wars 1**</span>: Read the footnote.<br>
	- <span>Star Wars 2**</span>: Read the footnote.<br>
	- <span>Star Wars 3**</span>: Read the footnote.<br>
	- <span>Star Wars 4**</span>: Read the footnote.<br>
	- <span>Teardrop</span>: Suitable for small number of tags (20 or 30), preferably icons. Even though the tags at the vertex may overlap.<br>
	- <span>Tire</span>: Good for any type and number of tags.<br>
	- <span>Torus</span>: Good for any type of tags. Bigger number of tags gives better results.<br>
	...
	- <span>Triangle pyramid</span> (Tetrahedron): Good for any type of cloud content and tags.
	- <span>UFO**</span>: Read the footnote.<br>
	- <span>V*</span>: Read the footnote.<br>
	- <span>W*</span>: Read the footnote.<br>
	- <span>Wall-E's Eyes**</span>: Read the footnote.<br>
	- <span>Walnut</span>: Read the footnote.<br>
	- <span>Wings**</span>: Read the footnote.<br>
	- <span>X*</span>: Read the footnote.<br>
	- <span>Y*</span>: Read the footnote.<br>
	- <span>Yin Yangish**</span>: Read the footnote.<br>
	- <span>Z/S*</span>: Read the footnote.<br>
	======================<br>
	* These are shapes with limited practical usage. They don't give enough space for the tags even in a big size cloud - tags look packed. Therefore it's difficult to use them as 
	separate links. Better results can be obtained by dressing up your cloud with hundreds copies of one link only (preferably a single character or a small rounded image - <span>
	Image Scale</span> about 0.3-0.5). Thus the entire cloud itself becomes a link. In this case the canvas may have very small size (90x90) because there is no necessity 
	of looking for separate links in it.<br>
    ** These shapes have complex surface with sharp vertices and/or hedges. Due to it if you use small number of tags they can't show the beauty of the shape, and if you increase 
	their number, those at the above mentioned places start overlapping each other. So the best results can be achieved by:<br>
	- creating a big canvas (960x960 +) up to full screen size<br>
	- usage of small, rounded image tags (<span>Image Scale</span> about 0.3-0.5);<br>
	- increasing number of tags up to several hundred by <span>Repeat Tags</span>;<br>
	- playing with <span>Magic</span> option for getting better tags distribution.
	</p>
	<p><span>4. </span>Don't be surprised that <span>Radius Z</span> option has no effect when a 2D shape has been selected. If the shape is <span>Beam</span> both option <span>Radius Y</span> and <span>Radius Z</span> have no effect.</p>
	<p><span>5. </span>Be aware that some shapes need specific number of tags in order to look completed. These are: <span>3D axes</span>, <span>Christmas fir</span>, <span>Circles</span>, 
	<span>Cube</span>, <span>Hexagon</span> (Bee Cell), <span>Beam</span>, <span>Antenna</span>, <span>Peg top</span> (horizontal & vertical), <span>Sandglass</span>, <span>Spiral</span>, 
	<span>Square</span>, <span>Triangle</span> and <span>Triangle pyramid</span>. Because of that if the tags in your cloud are less than what you have set in corresponding 
	<span>Number</span> field the plugin will build a level smaller shape. When tags reach that number, plugin will build a level bigger shape. Here is an example: You want shape 
	<span>Cube</span> for your <span>Post tags</span> and the <span>Number</span> you have selected is <span>26</span>. But the real number of tags you have is 15. In this case 
	plugin will build a cube of 8 tags (2x2x2). When tags in your blog increase to 26, plugin will build 3x3x3 cube cloud (26 and not 27 because it is a shell only).</p>
	</div>
...
<div class="section_content" style="padding-bottom: 0;">
	<div id="accordion-6" style="padding: 0 0 3px;">
		<h3 style="margin-top: 5px;">1. How to add tag clouds via Shortcode?</h3>
		<div class="section_content">
			<p>
			 - Go to <span>Widgets</span> page of your WP Admin Panel and open the widget.<br>
			 - Set the options for your cloud and save that widget instance in <span>Inactive Widgets</span>.<br>
			 - A message with a Shortcode for adding the cloud in a page/post will pop up.<br>
			 - Copy & Paste it where you want it to appear.<br>	 
			 - For a later use the Shortcode will be available at the top of that widget instance in <span>WIDGET OPTIONS</span> section.<br>
			</p>
		</div>
		<h3>2. How to create a Tag Cloud of images?</h3>
		<div class="section_content"> 
			<p>
				...
				The <span>Menu</span> case is explained in tip #3.
		...
		<h3>3. How to create a Menu of images for a Tag Cloud?</h3>
		<div class="section_content">
			<p>
				...
				<span>&lt;img src="http://your-domain.com/your-folder/your-image.jpg"&gt;Home</span><br> It is good to	use small square (let say 108x108px) images. 
		...
		<h3>4. How to anchor an important tag?</h3>
		<div class="section_content">
			<p>
				...
				When menu items or pages are even number, the one in the beginning of second half will be anchored at the top. See this <a style="color:#dc143c; font-weight: bold;" href="http://peter.bg/archives/7373#anchor" target="_blank"><b>example</b></a>.
			</p>
		</div>
		<h3>5. How to create a Slideshow Imitation?</h3>
		<div class="section_content">
			<p>
		...
		<h3>6. How to put your logo in the center of the cloud?</h3>
		<div class="section_content">
			<p>
				...
				<a style="color:#dc143c; font-weight: bold;" href="http://diveintohtml5.info/canvas.html" target="_blank">LET'S CALL IT A DRAW(ING SURFACE)</a><br>
				and<br>
				<a style="color:#dc143c; font-weight: bold;" href="http://www.w3schools.com/html/html5_canvas.asp" target="_blank">HTML5 Canvas</a>.<br>
				...
				<a style="color:#dc143c; font-weight: bold;" href="http://peter.bg/archives/7840" title="Go there and get one!" target="_blank">Samples of Center Function</a>
			</p>
		</div>
		<h3>7. How to stop tag outline pulsation?</h3>
		<div class="section_content">
			<p>
				Set <span>Pulsate to Opacity</span> option value to 1.
			</p>
		</div>
		<h3>8. How to make 'Magic'?</h3>
		<div class="section_content">
			<p>
				Before making a <span>Magic</span> you have to select <span>SHAPE</span> and <span>CONTENT</span>. Another condition for good result is to have small 
				number of tags (for instance 5-30) but multiplied by <span>Repeat Tags</span> up to 200-400 in a big canvas (960x960 +). It's good to use small size, 
				rounded image tags (<span>Image Scale</span> about 0.3-0.5). Each <span>Magic</span> value is given a name of a movie. The first value is for no 
				magic, the last - for randomly generated, which may differ from the rest in the list. Before publishing on your site test the selected shape and 
				content with different values of <span>Magic</span> in order to find one or several, which give	amazing result. Multiple selection is allowed, so if 
				you choose it the plugin will change your cloud's view while rotating (Shape/Magic Time about 10-15 sec.). Be aware of five things:
				- Only shapes denoted with triple asterisks (<span>***</span>) are suitable fot <span>Magic</span>;<br> 
				- The result depends on the shape and in the same time on the number of original tags (before multiplaying with <span>Repeat Tags</span>) in the 
				cloud, meaning to say that a magic, applied on a shape with (let say) 25 tags, will give result different from same magic, applied to same shape with 
				26 tags.
				- The random option (last one) may create namazing and unexpected view of your cloud but in most cases will offer something not very nice;<br>
				- A <span>Magic</span> value may work nice with a shape, and may not work with another, therefore avoid combining shape multiple selection with magic 
				multiple selection.<br>
				- Avoid combining multiple magic selection with multiple colors/backgrounds because the latter works on random principle and thus will spoil the beauty 
				of the order, created by a magic. 
			</p>
		</div>
		<h3>9. How to ask a question or make a suggestion?</h3>
		<div class="section_content">
			<p>
				<a style="color:#dc143c; font-weight: bold;" href="mailto:peter.m.petrov@gmail.com">Email me</a>.
			</p>
		</div>
	</div>
</div>	